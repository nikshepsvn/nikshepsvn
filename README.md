...
Fun fact: I actually started building RealmPlay before Llama and was about to put a pause on it since all the models I evalualted prior to it (GPT-J, Pythia, GPT-NeoX-20B etc.) lacked coherency over long conversations -- just about as I was pause building, the LLM lords at Meta saved the day with the first ever Llama release.
